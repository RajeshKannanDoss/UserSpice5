...
?>
 ...
 {
     //if(!preg_match('/^[0-9]{3}-[0-9]{3}-[0-9]{4}$/', $_POST['mobile_no']) )
     
         if(!preg_match('/^[0-9]{3}-[0-9]{3}-[0-9]{4}$/', $db->update('users',$theNewId,['mobile_no'=>Input::get('mobile_no')]))
     {
     ...
     //$db->update('users',$theNewId,['mobile_no'=>Input::get('mobile_no')]);
     dump($mobile_no);
